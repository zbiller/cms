...
class TranslationService
{
    ...
    {
        $count = 0;
        $groups = Translation::distinctGroup()->whereNotNull('value')->get('group');
    ...
    protected function exportGroupFilesTranslations($group = null)
    {
        ...
        $tree = $this->toTree(
            Translation::ofTranslatedGroup($group)->orderByGroupKeys()->get()
        );
        ...
        return Translation::ofTranslatedGroup($group)->count();
    }
    ...
    {
        $tree = $this->toTree(
            Translation::ofTranslatedGroup(self::JSON_GROUP)->orderByGroupKeys()->get(), true
        );
        ...
        return Translation::ofTranslatedGroup(self::JSON_GROUP)->count();
    }
