...
namespace App\Http\Filters\Translation;
...
class TranslationFilter extends Filter
{
    ...
    {
        return [
            'search' => 'operator:like|condition:or|columns:key,value',
            'locale' => 'operator:=|condition:or|columns:locale',
            'group' => 'operator:=|condition:or|columns:group',
