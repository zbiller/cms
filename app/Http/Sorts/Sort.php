...
abstract class Sort
{
     ...
     * Meaning that the Sortable trait will look for this request name when deciding what to sort by.
     *
     * @const
     */
     ...
     * Meaning that the Sortable trait will look for this request name when deciding the sorting direction.
     *
     * @const
     */
