    ...
    @foreach($revisions as $index => $revision)
        <tr>
            ...
            <td>
                ...
                <a href="{{ route($route, $parameters + ['revision' => $revision->id]) }}" class="btn yellow no-margin-top no-margin-bottom {!! !(auth()->user()->isDeveloper() || auth()->user()->hasPermission('revisions-view')) ? 'disabled' : '' !!}">
