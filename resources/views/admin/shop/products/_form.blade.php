...
<div id="tab-5" class="tab tab-attributes">
    @include('admin.shop.products.attributes.assign', ['item' => $item, 'draft' => $draft ?? null, 'revision' => $revision ?? null, 'disabled' => isset($on_revision) ? true : false])
</div>
<div id="tab-6" class="tab tab-discounts">
    @include('admin.shop.products.discounts.assign', ['item' => $item, 'draft' => $draft ?? null, 'revision' => $revision ?? null, 'disabled' => isset($on_revision) ? true : false])
</div>
<div id="tab-7" class="tab tab-taxes">
    @include('admin.shop.products.taxes.assign', ['item' => $item, 'draft' => $draft ?? null, 'revision' => $revision ?? null, 'disabled' => isset($on_revision) ? true : false])
</div>
