{!! form()->open(['url' => request()->url(), 'method' => 'GET']) !!}
    ...
    <fieldset>
        {!! form()->number('price[0]', request('price')[0] ?: null, ['placeholder' => 'Price From', 'style' => 'width: 48%;']) !!}
        {!! form()->number('price[1]', request('price')[1] ?: null, ['placeholder' => 'Price To', 'style' => 'width: 48%;']) !!}
    </fieldset>
    <fieldset>
        {!! form()->number('quantity[0]', request('quantity')[0] ?: null, ['placeholder' => 'Quant. From', 'style' => 'width: 48%;']) !!}
        {!! form()->number('quantity[1]', request('quantity')[1] ?: null, ['placeholder' => 'Quant. To', 'style' => 'width: 48%;']) !!}
    </fieldset>
    <fieldset>
