{!! form()->open(['url' => request()->url(), 'method' => 'GET']) !!}
    ...
    <fieldset>
        {!! form()->number('total_from', request()->query('total_from') ?: null, ['placeholder' => 'Total From', 'style' => 'width: 48%;']) !!}
        {!! form()->number('total_to', request()->query('total_to') ?: null, ['placeholder' => 'Total To', 'style' => 'width: 48%;']) !!}
    </fieldset>
    <fieldset>
        {!! form()->number('count_from', request()->query('count_from') ?: null, ['placeholder' => 'Count From', 'style' => 'width: 48%;']) !!}
        {!! form()->number('count_to', request()->query('count_to') ?: null, ['placeholder' => 'Count To', 'style' => 'width: 48%;']) !!}
    </fieldset>
    <fieldset>
